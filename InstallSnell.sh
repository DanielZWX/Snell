...
downloadSnellV2() {
    ...
    wget --no-check-certificate -N "https://raw.githubusercontent.com/DanielZWX/Snell/master/snell/v2.0.6/snell-server-v2.0.6-linux-${arch}.zip"
    if [[ $? -ne 0 ]]; then
...
downloadSnellV3() {
	...
	wget --no-check-certificate -N "https://raw.githubusercontent.com/DanielZWX/Snell/master/snell/v3.0.1/snell-server-v3.0.1-linux-${arch}.zip"
